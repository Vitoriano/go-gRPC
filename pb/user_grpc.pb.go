...
func (x *userServiceAddUserVerboseClient) Recv() (*UserResultsStream, error) {
	m := new(UserResultsStream)
...
func (x *userServiceAddUserStreamBothClient) Recv() (*UserResultsStream, error) {
	m := new(UserResultsStream)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *userServiceAddUserVerboseServer) Send(m *UserResultsStream) error {
...
func (x *userServiceAddUserStreamBothServer) Send(m *UserResultsStream) error {
	return x.ServerStream.SendMsg(m)
}
